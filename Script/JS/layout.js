...
header.innerHTML = '<div class="container R"><div><a href="./main.html" class="logo R remove"><img src="../Web_logo.png" alt="logo"><span>QUEENTURE</span></a></div><div class="nav R C"><span><a class="remove" href="./main.html">Home</a></span><span><a class="remove" href="./store.html">Store</a></span><span><a class="remove" href="./contact.html">Contact</a></span><span><a class="remove" href="./about.html">About</a></span><span><a class="remove" href="./signup.html">Sign</a> up</span></div><div class="control R C"><div class="profile R C"><a class="heart R C remove" href="./wishlist.html"><svg width="16" height="16" viewBox="0 0 16 16"><path d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z" /></svg><div class="noti">2</div></a><a class="cart R C remove" href="./cart.html"><svg width="16" height="16" viewBox="0 0 16 16"><path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" /></svg><div class="noti">2</div></a><a class="account R C remove" href="./account.html"><svg width="512" height="512" viewBox="0 0 512 512"><path d="M344,144c-3.92,52.87-44,96-88,96s-84.15-43.12-88-96c-4-55,35-96,88-96S348,90,344,144Z" /><path d="M256,304c-87,0-175.3,48-191.64,138.6C62.39,453.52,68.57,464,80,464H432c11.44,0,17.62-10.48,15.65-21.4C431.3,352,343,304,256,304Z" /></svg></a></div></div></div>';
...
let signup = document.querySelector(".header .nav span:nth-of-type(5)");
let heart = document.querySelector(".header .profile .heart");
let cart = document.querySelector(".header .profile .cart");
...
if (Sto_Cart) {
    ...
    if (Sto_Cart.length == 0) cart.classList.remove("active");
}
